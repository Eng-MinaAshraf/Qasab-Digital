 ...
 * @returns {object}
 */
export function generateProductJsonLd(product, baseUrl = 'https://qasab-digital.vercel.app') {
 ...
 * @returns {object}
 */
export function generateBreadcrumbJsonLd(product, baseUrl = 'https://qasab-digital.vercel.app') {
  const cleanBaseUrl = baseUrl.replace(/\/$/, '');
