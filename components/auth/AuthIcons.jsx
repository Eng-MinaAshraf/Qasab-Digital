...
export function AppleIcon({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.84c.66-.83 1.11-1.98.99-3.14-1 .04-2.23.68-2.93 1.5-.62.72-1.16 1.88-1.02 3 .01 0 .03 0 .05 0 1.05 0 2.25-.53 2.91-1.36z" />
    </svg>
  );
}

export function SugarcaneStalkIcon({ size = 28, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className}>
      <path d="M10 28V4M16 28V4M22 28V4" stroke="#166534" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M7 10h18M7 18h18" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round" />
      <path d="M16 4c3-3 8-1 10 2M16 12c4-2 7 0 9 3M10 8c-3-2-7 0-8 3" stroke="#22C55E" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function EgyptFlagIcon({ size = 18, className = '' }) {
  return (
    <svg
      width={size}
      height={size * 0.67}
    ...
    >
      ...
      <circle cx="12" cy="8" r="1.3" fill="#C09322" />
    </svg>
  );
}
